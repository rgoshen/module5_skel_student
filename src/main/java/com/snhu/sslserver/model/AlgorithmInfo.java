...
/**
 * Immutable data model representing information about a cryptographic algorithm. This class
 * provides metadata about hash algorithms including security status, performance characteristics,
...
public class AlgorithmInfo {
  ...
  /**
   * Creates an immutable set, avoiding unnecessary copying if the input is already immutable. This
   * optimization prevents performance overhead when dealing with already immutable sets.
   *
  ...
  /**
   * Builder class for constructing AlgorithmInfo instances. Provides a fluent interface for
   * creating AlgorithmInfo objects.
   */
