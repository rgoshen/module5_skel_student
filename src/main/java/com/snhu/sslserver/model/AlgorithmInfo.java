...
/**
 * Immutable data model representing information about a cryptographic algorithm.
...
public class AlgorithmInfo {
    ...
    public AlgorithmInfo(String name, boolean secure, PerformanceRating performance, 
        ...
        this.aliases = Set.copyOf(Objects.requireNonNull(aliases, "Aliases cannot be null"));
    }
