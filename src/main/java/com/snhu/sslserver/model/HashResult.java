...
/**
 * Immutable data model representing the result of a hash computation. This class encapsulates all
 * relevant information about a hash operation including the original data, algorithm used, computed
 * hash, and metadata.
 *
 * @author Rick Goshen
 * @version 1.0
...
public class HashResult {
  ...
  public HashResult(
    ...
    if (computationTimeMs < 0) {
      throw new IllegalArgumentException(
          "Computation time cannot be negative: " + computationTimeMs);
    }
  ...
  /**
   * Builder class for constructing HashResult instances. Provides a fluent interface for creating
   * HashResult objects.
   */
