...
/**
 * Enumeration representing performance characteristics of cryptographic algorithms.
...
public enum PerformanceRating {
    ...
    /**
     * Fast algorithms with excellent performance characteristics.
     * Suitable for high-throughput scenarios where performance is critical.
     */
    FAST("Fast - Excellent performance for high-throughput scenarios"),
    
    /**
     * Medium performance algorithms that balance speed and security.
     * Good general-purpose choice for most applications.
     */
    MEDIUM("Medium - Good balance of performance and security"),
    
    /**
     * Slower algorithms that prioritize maximum security.
     * Best for high-security scenarios where performance is less critical.
     */
