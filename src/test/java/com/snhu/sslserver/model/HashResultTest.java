...
/**
 * Unit tests for HashResult model class. Tests constructor validation, getters, equals/hashCode,
 * and builder pattern.
 */
...
class HashResultTest {
  ...
  private static final String SAMPLE_HEX_HASH =
  ...
  void shouldThrowExceptionWhenAlgorithmIsNull() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            ...
            () ->
                new HashResult(
                    SAMPLE_DATA, null, SAMPLE_HEX_HASH, SAMPLE_TIMESTAMP, SAMPLE_COMPUTATION_TIME));
  ...
  void shouldThrowExceptionWhenTimestampIsNull() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            ...
            () ->
                new HashResult(
                    SAMPLE_DATA, SAMPLE_ALGORITHM, SAMPLE_HEX_HASH, null, SAMPLE_COMPUTATION_TIME));
  ...
  void shouldThrowExceptionWhenComputationTimeIsNegative() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            ...
            () ->
                new HashResult(
                    SAMPLE_DATA, SAMPLE_ALGORITHM, SAMPLE_HEX_HASH, SAMPLE_TIMESTAMP, -1L));
  ...
  void shouldAcceptZeroComputationTime() {
    // When
    HashResult result =
        new HashResult(SAMPLE_DATA, SAMPLE_ALGORITHM, SAMPLE_HEX_HASH, SAMPLE_TIMESTAMP, 0L);
  ...
  void shouldHandleVeryLongComputationTime() {
    ...
    HashResult result =
        new HashResult(
            SAMPLE_DATA, SAMPLE_ALGORITHM, SAMPLE_HEX_HASH, SAMPLE_TIMESTAMP, veryLongTime);
