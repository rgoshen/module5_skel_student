...
/**
 * Unit tests for PerformanceRating enum.
 * Tests enum values, descriptions, and behavior.
 */
...
class PerformanceRatingTest {
    ...
    void shouldHaveCorrectDescriptionsForEachRating() {
        // Then
        assertEquals("Fast - Excellent performance for high-throughput scenarios", 
                    PerformanceRating.FAST.getDescription());
        assertEquals("Medium - Good balance of performance and security", 
                    PerformanceRating.MEDIUM.getDescription());
        assertEquals("Slow - Maximum security, suitable for high-security scenarios", 
    ...
    void shouldThrowExceptionForInvalidValueOf() {
        ...
        assertThrows(IllegalArgumentException.class, () -> 
            PerformanceRating.valueOf("INVALID")
        );
    }
